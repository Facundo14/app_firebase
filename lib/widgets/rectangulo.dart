...
class RectanguloAnimado extends StatefulWidget {
  @override
  _RectanguloAnimadoState createState() => _RectanguloAnimadoState();
}

class _RectanguloAnimadoState extends State<RectanguloAnimado> with SingleTickerProviderStateMixin {
